#' pre-process a pedigree for calculations
#' @export
#' 
...
setGeneric('ComputeKinshipPropCoef', function(obj)
    {standardGeneric('ComputeKinshipPropCoef')})

setMethod('ComputeKinshipPropCoef', signature(), function(obj)
{
    ...
    if (length(iancestors)>2)
        stop ("Not able yet to handle pedigree with more than 2 intermediate ancestors")
